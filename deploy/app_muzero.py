"""Modal app: MuZero on the Franka reach task.
...
Usage::
    ...
    modal run deploy/app_muzero.py                     # gpu preset
    modal run deploy/app_muzero.py --preset xl
    modal run deploy/app_muzero.py --preset cpu-parity # laptop knobs, on a GPU
"""
