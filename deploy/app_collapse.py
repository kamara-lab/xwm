"""Modal app: anti-collapse strategy comparison.
...
Usage::
    ...
    modal run deploy/app_collapse.py                     # gpu preset
    modal run deploy/app_collapse.py --preset xl
    modal run deploy/app_collapse.py --preset cpu-parity # laptop knobs, on a GPU
"""
