...
Usage::
    ...
    modal run deploy/app_image.py                     # gpu preset
    modal run deploy/app_image.py --preset xl
    modal run deploy/app_image.py --preset cpu-parity # laptop knobs, on a GPU
"""
