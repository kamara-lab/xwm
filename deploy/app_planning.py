"""Modal app: planning with a learned world model.
...
Usage::
    ...
    modal run deploy/app_planning.py                     # gpu preset
    modal run deploy/app_planning.py --preset xl
    modal run deploy/app_planning.py --preset cpu-parity # laptop knobs, on a GPU
"""
