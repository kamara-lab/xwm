"""Modal app: V-JEPA tube masking on video.
...
Usage::
    ...
    modal run deploy/app_video.py                     # gpu preset
    modal run deploy/app_video.py --preset xl
    modal run deploy/app_video.py --preset cpu-parity # laptop knobs, on a GPU
"""
