"""Modal app: action-conditioned latent dynamics.
...
Usage::
    ...
    modal run deploy/app_action.py                     # gpu preset
    modal run deploy/app_action.py --preset xl
    modal run deploy/app_action.py --preset cpu-parity # laptop knobs, on a GPU
"""
