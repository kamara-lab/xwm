"""Modal app: TD-MPC2 on the Franka reach task.
...
Usage::
    ...
    modal run deploy/app_tdmpc2.py                     # gpu preset
    modal run deploy/app_tdmpc2.py --preset xl
    modal run deploy/app_tdmpc2.py --preset cpu-parity # laptop knobs, on a GPU
"""
